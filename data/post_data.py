...
def post_result(schema,table_name, csv_file_path):
    ...
    try:
        ...
        copy_query = f"COPY {schema}.{table_name} FROM LOCAL'{csv_file_path}'  DELIMITER '|'; COMMIT;"
...
if __name__ == "__main__":
    table_name = "test_conceptos"  # Nombr1e de la tabla en Vertica
    schema = "DEV_FACTURACION"
    csv_file_path = 'temp/03-10-2023_10-30-57/concepto_03-10-2023_10-31-34.csv'# Esquema en Vertica
